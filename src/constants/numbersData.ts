...
export const NUMBERS_1_19: NumberData[] = [
  { number: 1, somali: "Kow", danish: "en", audioPath: "/Tal/1.mp3"},
  { number: 2, somali: "Laba", danish: "to", audioPath: "/Tal/2.mp3"},
  { number: 3, somali: "Saddex", danish: "tre", audioPath: "/Tal/3.mp3" },
  ...
  { number: 7, somali: "Todobaad", danish: "syv", audioPath: "/Tal/7.mp3" },
  ...
  { number: 12, somali: "Laba iyo toban", danish: "tolv", audioPath: "/Tal/12.mp3" },
  { number: 13, somali: "Saddex iyo toban", danish: "tretten", audioPath: "/Tal/13.mp3" },
