  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-b from-blue-50 via-white to-white px-4 py-12 animate-fade-in">
      <div className="w-full max-w-md bg-white rounded-xl shadow-xl px-8 py-10 border border-blue-100">
        <h1 className="text-2xl font-bold mb-5 text-center text-blue-600">Vælg dit abonnement</h1>
        <div className="mb-6 text-center text-blue-700 bg-blue-50 rounded py-3 px-4 border border-blue-200 font-medium">
        ...
        <div className="space-y-6">
          {plans.map((p) => (
            <div key={p.value} className="rounded-lg border border-blue-200 p-5 flex flex-col items-center bg-blue-50">
              ...
              <Button className="w-full bg-blue-500 hover:bg-blue-600" onClick={() => handleChoose(p.value)}>
                Vælg {p.label}
              </Button>
            </div>
          ))}
