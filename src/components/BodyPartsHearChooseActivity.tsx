...
interface BodyPartsHearChooseActivityProps {
  onBack: () => void;
}

export default function BodyPartsHearChooseActivity({ onBack }: BodyPartsHearChooseActivityProps) {
  ...
  return (
    <div className="flex flex-col items-center space-y-6 p-6">
      <h3 className="text-2xl font-bold text-blue-700 mb-4">Hør og vælg</h3>
      ...
      <Tabs value={activeTab} onValueChange={handleTabChange} className="w-full max-w-2xl">
        ...
        <TabsContent value={activeTab} className="mt-6">
          <div className="text-center mb-6">
            <p className="text-lg mb-4">Hør ordet og klik på det rigtige billede:</p>
            <Button
            ...
            {options.map((option) => (
              <div
                ...
                className={`
                  ...
                  ${!showResult ? 'border-gray-200 hover:border-blue-300' : ''}
              ...
              >
                <div className="text-center">
                  <div className="w-24 h-24 mx-auto mb-3 bg-blue-50 rounded-full flex items-center justify-center overflow-hidden">
                    <img 
                      src={option.image} 
                      alt={option.danish}
                  ...
                  <p className="text-sm text-gray-600">{option.danish}</p>
                </div>
              </div>
            ))}
          </div>
