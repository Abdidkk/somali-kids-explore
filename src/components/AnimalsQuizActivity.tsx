...
export default function AnimalsQuizActivity({ onBack }: AnimalsQuizActivityProps) {
    ...
    return (
      <div className="flex flex-col items-center space-y-6 p-6">
        ...
        <div className="text-center">
          <p className="text-xl mb-4">Du fik {score} ud af 8 rigtige!</p>
  ...
  return (
    <div className="flex flex-col items-center space-y-6 p-6">
      <h3 className="text-2xl font-bold text-green-700 mb-4">Test din viden</h3>
      
      <div className="text-center mb-4">
        <p className="text-lg mb-2">Spørgsmål {questionCount + 1} af 8</p>
