...
const FoodModal: React.FC<FoodModalProps> = ({
  ...
  return (
<div className="fixed z-50 inset-0 flex items-start md:items-center justify-center bg-black/20 backdrop-blur-sm overflow-y-auto scroll-smooth py-6 md:py-10">
