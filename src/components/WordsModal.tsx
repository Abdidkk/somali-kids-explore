...
const WordsModal: React.FC<WordsModalProps> = ({ open, onClose }) => {
  ...
  return (
    <div className="fixed z-50 inset-0 flex items-center justify-center bg-black/20 backdrop-blur-sm overflow-y-auto pt-[75rem] md:py-10">
      <div className={`bg-white rounded-xl shadow-xl ${isMobile ? 'px-4 py-5' : 'px-7 py-6'} w-full max-w-2xl relative animate-in fade-in-50 my-auto mx-2 md:mx-4`}>
        ...
        <h2
          ...
          } font-semibold text-orange-700 mb-3 md:mb-5 text-center pt-3`}
        >
          Somaliske ord
        </h2>
          ...
          <div className="flex flex-col gap-6 md:gap-8 py-6 md:py-8 px-3 md:px-4 max-w-2xl mx-auto">
            ...
            >
              ...
              <div>
                ...
                >
                  Hør somaliske ord og lær deres betydning
                </p>
              </div>
            </button>
            ...
            >
              ...
              <div>
                ...
                >
                  En lille quiz hvor du viser, hvad du har lært
                </p>
              </div>
            </button>
          </div>
